...
const EditEducation = ({ oldEducation }) => {
  const [education, setEducation] = useState(oldEducation);

  const { updateEducation, loading } = useEducationStore();
...
EditEducation.propTypes = {
  oldEducation: PropTypes.object.isRequired,
};
